...
//         title: "Popup added",
//         body: "${ua.auth.currentUser!.displayName} added $title");
//   }
...
//             body:
//                 "${ua.auth.currentUser!.displayName} added ${mya.coursework!.title}");
...
//             body:
//                 "${ua.auth.currentUser!.displayName} changed the assignment ${mya.coursework!.title}");
//         FirebaseFirestore.instance
//             .collection('Assignments')
//             .doc(mya.coursework!.courseId! + mya.coursework!.id!)
//             .update({
